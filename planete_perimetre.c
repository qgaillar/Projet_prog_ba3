...
void fichierCSV ( char* filename, int centre_x, int centre_y, double demi_grand_axe, double demi_petit_axe, int iterations) {
...
int main(int argc, char * argv[]) {
	...
	struct Planete Mercure = {"Mercure", 1556.625, 0.2589, 0, 0, 1};
	...
	struct Planete Venus = {"Venus", 1628.115, 0.0051, 0, 0, 3};
	...
	struct Planete Terre = {"Terre", 1750.5, 0.101, 0, 0, 3};
	...
	struct Planete Mars = {"Mars", 2027.84, 0.103, 0, 0, 6};
	...
	struct Planete Jupiter = {"Jupiter", 2678.345, 0.0507, 0, 0, 10};
	...
	struct Planete Saturne = {"Saturne", 3027.18, 0.0593, 0, 0, 20};
	...
	struct Planete Uranus = {"Uranus", 4070.83, 0.0482, 0, 0, 30};
	...
	struct Planete Neptune = {"Neptune", 4496.975, 0.0098, 0, 0, 30};
