...
int main(int argc, char * argv[]) {
	...
	struct Planete Mercure = {"Mercure", 56.625, 0.2589, 0, 0, 1};
	...
	struct Planete Venus = {"Venus", 128.115, 0.0051, 0, 0, 3};
	...
	struct Planete Terre = {"Terre", 150.5, 0.101, 0, 0, 3};
	...
	struct Planete Mars = {"Mars", 227.84, 0.103, 0, 0, 6};
	...
	struct Planete Jupiter = {"Jupiter", 778.345, 0.0507, 0, 0, 10};
	...
	struct Planete Saturne = {"Saturne", 1427.18, 0.0593, 0, 0, 20};
	...
	struct Planete Uranus = {"Uranus", 2870.83, 0.0482, 0, 0, 30};
